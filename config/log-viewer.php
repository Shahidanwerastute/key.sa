...
return [
    ...
    */
    ...
    'back_to_system_url' => Custom::baseUrl('admin/welcome'),

    'back_to_system_label' => 'Back To Admin Panel', // Displayed by default: "Back to {{ app.name }}"
