...
<div id="page_content">
  <div id="page_content_inner">
  	<form action="{{ custom::baseurl('/') }}/admin/page/update" method="post" onsubmit="return false" class="ajax_form">
    	<input type="hidden" name="table_name" value="about_us">
        ...
        <h3 class="heading_a">Content</h3>
            <div class="uk-grid" data-uk-grid-margin>
                ...
                <div class="uk-width-large-1-2">                        
                  <div class="uk-width-1-1">
                      <div id="file_upload-drop" class="uk-file-upload">
                          ...
                          <p class="uk-text-muted uk-text-small uk-margin-small-bottom"></p>
                          <p style="color:red; font-size:12px">(298 x 332 pixels)</p>
                      </div>
                      <div id="file_upload-progressbar" class="uk-progress uk-hidden">
                          <div class="uk-progress-bar" style="width:0">0%</div>
                      </div>
                ...
                <div class="uk-width-medium-1-2">
                  ...
                  <div class="uk-form-row">
                     @if($content->image1) 
                     	<img src="{{ custom::baseurl('/public/uploads') . '/' . $content->image1 }}" alt="Banner Image" data-uk-modal="{target:'#modal_lightbox2'}" width="200">
                     @endif
                  </div>
                </div>
