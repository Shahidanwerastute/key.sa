...
<div id="page_content">
  <div id="page_content_inner">
  	<form action="{{ custom::baseurl('/') }}/admin/page/update" method="post" onsubmit="return false" class="ajax_form">
    	<input type="hidden" name="table_name" value="change_points">
        <input type="hidden" name="id" value="1">
        <input type="hidden" name="type" value="au">
    <div class="md-card">
      <div class="md-card-content">
        <h3 class="heading_a">Edit Change Your Points</h3>
            <div class="uk-grid" data-uk-grid-margin>
                ...
                <div class="uk-width-medium-1-2">
                  ...
                  <div class="uk-form-row">
                     @if($content->image)
                     	<img src="{{ custom::baseurl('/public/uploads') . '/' . $content->image }}" alt="Banner Image" data-uk-modal="{target:'#modal_lightbox'}" width="400">
                     @endif
                  </div>
                </div>
                ...
                <div class="uk-width-medium-1-2">
                    ...
                    <div class="uk-form-row">
                        ...
                        <input type="text" class="md-input" value="@if($content->image_eng_alt) {{ $content->image_eng_alt }}@endif" name="image_eng_alt" style="font-size: 12px;" />
                    </div>
                </div>
                <div class="uk-width-medium-1-2">
                    ...
                    <div class="uk-form-row">
                        ...
                        <input type="text" class="md-input" value="@if($content->image_arb_alt) {{ $content->image_arb_alt }}@endif" name="image_arb_alt" style="font-size: 12px;" />
                    </div>
                </div>
        ...
        @if($content->image)
            <div class="uk-modal" id="modal_lightbox">
                <div class="uk-modal-dialog uk-modal-dialog-lightbox">
                    ...
                    <img src="{{ custom::baseurl('/public/uploads') . '/' . $content->image }}" alt=""/>
                </div>
            </div>
        @endif
