...
<div id="page_content">
  <div id="page_content_inner">
      <div class="" style="text-align: right;margin-bottom: 15px;">
          <a class="md-btn md-btn-primary md-btn-wave-light md-btn-icon waves-effect waves-button waves-light" href="{{ custom::baseurl('/admin/page/program-rewards-sorting') }}">
  	...
  	<form action="{{ custom::baseurl('/') }}/admin/page/update" method="post" onsubmit="return false" class="ajax_form">
    	<input type="hidden" name="table_name" value="program_rewards_content">
        <input type="hidden" name="id" value="1">
        <input type="hidden" name="type" value="nc">
    <div class="md-card">
      <div class="md-card-content">
        <h3 class="heading_a">Edit Program Rewards</h3>
   ...
   <div class="md-card">
      	<div class="md-card-content">
        	<div id="programAwardsListTable"></div>
    	</div>
    </div>
