                    ...
                    <td style="padding:14px 33px 14px 50px; background:#444; border-bottom:2px solid #FE7E00;" class="topbar">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td style="text-align:left;"><a href="www.key.sa" style="font-size:12px; color:#FE7E00; font-family: 'Lato', sans-serif; text-decoration:none;">www.key.sa</a></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <td style="padding:14px 33px 12px 52px; background:#E1E1E1;" class="bar-code">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top;  padding: 15px 0px; font-size:12px; font-family: 'Lato', sans-serif;">المدينة</td>
                                <td style="font-size:12px; color:black; font-family: 'Lato', sans-serif;"><p style="display:block; margin:0; font-size:16px; line-height:20px; font-family: 'Lato', sans-serif; font-weight:400;"><?php echo $locations->c_arb_title; ?></p></td>

                            </tr>

                            <tr>
                                <td style="font-size:12px; width:50%; font-family: 'Lato', sans-serif;">الفرع </td>

                                <td style="font-size:12px; color:black; font-family: 'Lato', sans-serif;"><p style="display:block; margin:20px 0px; font-size:16px; line-height:20px; font-family: 'Lato', sans-serif; font-weight:400;"><?php echo $locations->arb_title; ?></p></td>
                            </tr>

                            <tr>
                                <td style="font-size:12px; width:50%; font-family: 'Lato', sans-serif;">عنوان </td>
                                <td style="font-size:12px; color:black; font-family: 'Lato', sans-serif;"><p style="display:block; margin:20px 0px; font-size:16px; line-height:20px; font-family: 'Lato', sans-serif; font-weight:400;"><?php echo $locations->address_line_2; ?></p></td>

                            </tr>

                            <tr>
                                <td style="font-size:12px; width:50%; font-family: 'Lato', sans-serif;"> ساعات العمل  </td>
                            ...
                            <tr>
                                <td style="font-size:12px; width:50%; font-family: 'Lato', sans-serif;">هاتف </td>

                                <td style="font-size:12px; color:black; font-family: 'Lato', sans-serif;"><p style="display:block; margin:20px 0px; font-size:16px; line-height:20px; font-family: 'Lato', sans-serif; font-weight:400;"><?php echo $locations->phone1; ?></p></td>
                            </tr>
                            <?php } ?>

                            <?php if($locations->mobile != ""){ ?>
                            <tr>
                                <td style="font-size:12px; width:50%; font-family: 'Lato', sans-serif;">رقم الجوال </td>
                            ...
                            <tr>
                                <td style="font-size:12px; width:50%; font-family: 'Lato', sans-serif;">البريد الإلكتروني </td>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top;  padding: 15px 0px; font-size:12px; font-family: 'Lato', sans-serif;">صورة الفرع</td>
