...
<body class="arb" bgcolor="#FFFFFF" style="background-color: #fff;" dir="rtl">
				...
				<table bgcolor="" style=" width: 100%; ">
					<tr>
						<td align="right" style="color:#fff;">
                            <?php
                            $path_noIcon = custom::baseurl('/resources/views/frontend/emails/images/noIcon.png');
                            ?>
		...
		<td class="header container" style="clear: both;display: block;margin: 0 auto;max-width: 600px">
			<div class="content" style="display: block;margin: 0 auto;max-width: 630px;padding: 15px;">
				<table class="userInfo" style=" width: 100%; ">
					<tr>
						<td colspan="2" align="right" valign="top" style="padding: 25px 0px 0px; ">
							<p style="color:#AB1D46; font-size: 13px; margin-bottom: 3px;line-height: 1.2;"> عزيزي <?php echo $data['name']; ?>,</p>
							<p style="color: #858585;font-size: 13px;line-height: 1.3;margin: 0;"><?php echo $data['message']; ?></p>
							<br />
						</td>
					</tr>
				</table>
...
<table class="head-wrap"  bgcolor="" style="margin: 0 auto;max-width: 680px;width: 100%;" >
	<tr>
		<td>&nbsp;</td>
		<td class="header container" style="clear: both;display: block;margin: 0 auto;max-width: 600px; padding-bottom:15px;">
			<div class="content" style="display: block;margin: 0 auto;max-width: 630px;padding: 0 15px 0;" >
				<table class="" style="border-collapse: collapse; width: 100%; " >
                    <?php foreach($data['info'] as $key => $info){ ?>
						<tr>
						<td align="right" style="border:1px solid; width: 150px;padding: 0 5px;" >
							<label style="
								color: #9f063f;
								display: block;
								font-size: 12px;
						...
						<td align="right" style="border:1px solid; padding: 0 5px;" >
							<p style="color: #858585;font-size: 13px;line-height: 1.3;margin: 0;"><?php echo $info; ?></p>
						</td>
					</tr>
                    <?php }?>
				</table>
		...
		<td class="header container" style="clear: both;display: block;margin: 0 auto;max-width: 600px">
			<div class="content" style="display: block;margin: 0 auto;max-width: 630px;padding: 15px;" >
				<table class="" style=" width: 100%; " >
					<tr>
						<td align="right" >
							<p style="color: #fff; font-size: 9px; margin: 0;">COPYRIGHTS 2016. ALL RIGHTS RESERVED.</p>
						</td>
						<td align="left" >
