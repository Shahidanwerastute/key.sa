                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="color:#fff; font-size:13px; line-height:14px; font-weight:bold; font-family: 'Lato', sans-serif;">
                                                    <p style="margin:0;">سعر الايجار قبل الخصم <?php echo $booking_content['original_rent']; ?> <?php echo $currency; ?></p>
                                                    <p style="margin:0;">تطبيق الخصم</p>
                                                    <p style="margin:0;"><strong style="font-size:25px; line-height:25px; font-weight:900;"><?php echo $booking_content['discount_price']; ?> <?php echo $currency; ?></strong></p>
                                                </td>
                                            </tr>
                                    </table>
                                </td>
