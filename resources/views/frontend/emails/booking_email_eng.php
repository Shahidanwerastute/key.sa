                    	...
                    	<td style="padding:14px 33px 14px 50px;" class="thead">
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            	...
                            	<tr>
                                    ...
                                    <h1 style="margin:0;font-family: 'Lato', sans-serif; font-size:22px; font-weight:400; line-height:22px; color:#f8ac1d;">BOOKING <p style="display:block; font-size:18px; line-height:18px; color:#666; font-family:300; margin:0;">CONFIRMATION</p></h1></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                    	<td style="padding:27px 33px 26px 52px; background:url(<?php if(isset($message)){ echo $message->embed($path_divider); } else{ echo $path_divider;} ?>) repeat-x; border-top:1px solid #ccc;" class="intro">
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            	<tr>
                                	<td>
                                    	<p style="margin:0 0 5px; color:#b8193d; font-family: 'Lato', sans-serif;font-weight:bold;">Dear <?php echo ($booking_content['first_name'] != '' ? $booking_content['first_name'] : $booking_content['icg_first_name'])." ".($booking_content['last_name'] != '' ? $booking_content['last_name'] : $booking_content['icg_last_name']); ?>,</p>
                                        <p style="margin:0; width:280px; font-family: 'Lato', sans-serif;">Thank you for booking with Key Car Rental, Please find your reservation details below.</p>
                                    </td>
                                    <td style="text-align:right;">
                                    	<p style="margin:0; color:#b8193d; font-family: 'Lato', sans-serif;font-weight:bold;">PICKUP BRANCH CONTACT DETAIL</p>
                                        ...
                                        <p style="margin:0; color:#444; font-family: 'Lato', sans-serif;"><?php echo $booking_content['branch_from_eng_title']; ?> <span style="color:#858585;">for any assistance</span></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                    	<td style="padding:14px 33px 12px 52px; background:#eff0e0;" class="bar-code">
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                ?>
                            	<tr>
                                	<td style="font-size:12px; width:50%; font-family: 'Lato', sans-serif;">RESERVATION NUMBER <p style="display:block; margin:0; font-size:16px; line-height:20px; font-family: 'Lato', sans-serif; font-weight:400;"><a href="javascript:void(0);" style=" color:#b8193d; text-decoration:none; cursor:default;"><?php echo $booking_content['reservation_code']; ?></a></p></td>
                                    <td style="width:50%; text-align:right;"><img src="<?php if(isset($message)){ echo $message->embed($path_captcha); } else{ echo $path_captcha;} ?>" width="227" height="61" alt="bar code" style="display:inline-block;"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                    	<td style="padding:25px 33px 27px 54px" class="toyota">
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            	<tr>
                                	<td>
                                    	<h2 style="margin:0 0 10px; font-size:24px; font-family: 'Lato', sans-serif; line-height:24px; color:#b8193d;"><?php echo $booking_content['car_type_eng_title']." ".$booking_content['car_model_eng_title']." ".$booking_content['year']; ?> <strong style="font-size:14px; font-weight:400; color:#858585;">OR SIMILAR</strong><p style="display:block; margin:0; font-size:11px; line-height:14px; color:#666;"><?php echo $booking_content['car_category_eng_title']; ?></p></h2>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr><td style="font-family: 'Lato', sans-serif;"><span style="color:#b8193d;font-weight:bold;">ID:</span> <a href="#" style="color:#666; text-decoration:none; cursor:default;"><?php echo custom::maskText($booking_content['id_no'], 4); ?></a></td></tr>
                                            <?php }else{ ?>
                                                <tr><td style="font-family: 'Lato', sans-serif;"><span style="color:#b8193d;font-weight:bold;">ID:</span> <a href="#" style="color:#666; text-decoration:none; cursor:default;"><?php echo custom::maskText($booking_content['icg_id_no'], 4); ?></a></td></tr>

                                            <?php } ?>
                                            <?php if($booking_content['mobile_no'] !=""){ ?>
                                            <tr><td style="font-family: 'Lato', sans-serif;"><span style="color:#b8193d;font-weight:bold;">M:</span> <a href="tel:<?php echo custom::maskText($booking_content['mobile_no'], 6); ?>" style="color:#666; text-decoration:none; cursor:pointer;"><?php echo custom::maskText($booking_content['mobile_no'], 6); ?></a></td></tr>
                                            <?php }else{ ?>
                                                <tr><td style="font-family: 'Lato', sans-serif;"><span style="color:#b8193d;font-weight:bold;">M:</span> <a href="tel:<?php echo custom::maskText($booking_content['icg_mobile_no'], 6); ?>" style="color:#666; text-decoration:none; cursor:pointer;"><?php echo custom::maskText($booking_content['icg_mobile_no'], 6); ?></a></td></tr>
                                            <?php } ?>
                                            <?php if($booking_content['email'] !=""){ ?>
                                            <tr><td style="font-family: 'Lato', sans-serif;"><span style="color:#b8193d;font-weight:bold;">E:</span> <a href="mailto:<?php echo custom::maskText($booking_content['email'], 3); ?>" style="color:#666; text-decoration:none; cursor:pointer;"><?php echo custom::maskText($booking_content['email'], 3); ?></a></td></tr>
                                            <?php }else{ ?>
                                                <tr><td style="font-family: 'Lato', sans-serif;"><span style="color:#b8193d;font-weight:bold;">E:</span> <a href="mailto:<?php echo custom::maskText($booking_content['icg_email'], 3); ?>" style="color:#666; text-decoration:none; cursor:pointer;"><?php echo custom::maskText($booking_content['icg_email'], 3); ?></a></td></tr>
                                    ...
                                    ?>
                                    <td style="text-align:right;"><img src="<?php if(isset($message)){ echo $message->embed($path_car); } else{ echo $path_car;} ?>" width="255" height="123" alt="Car" style="display:inline-block;"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        	...
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            	<tr>
                                	<td style="background:#eff0e0; width:50%; border-bottom:2px solid #fff; padding:18px 54px 20px;" class="col-4">
                                    	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        	...
                                        	<tr><td><h3 style="color:#b8193d; margin:0; font-size:12px; line-height:16px; text-transform:uppercase; font-weight:bold; font-family: 'Lato', sans-serif;">PICK UP</h3></td></tr>
                                        	<tr><td style="padding-top:16px; font-family: 'Lato', sans-serif; font-weight:bold; color:#444; font-size:11px; line-height:14px;"><img src="<?php if(isset($message)){ echo $message->embed($path_ico1); } else{ echo $path_ico1;} ?>" width="9" height="12" alt="" style="display:inline-block; vertical-align:middle;">&nbsp;&nbsp;&nbsp; <?php echo $booking_content['branch_from_eng_title']; ?></td></tr>
                                    ...
                                    <td style="background:#eff0e0; width:50%; border-bottom:2px solid #fff; border-left:2px solid #fff; padding:18px 54px 20px;" class="col-4">
                                    	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        	<tr><td><h3 style="color:#b8193d; margin:0; font-size:12px; line-height:16px; text-transform:uppercase; font-weight:bold; font-family: 'Lato', sans-serif;">DROP OFF</h3></td></tr>
                                        	<tr><td style="padding-top:16px; font-family: 'Lato', sans-serif; font-weight:bold; color:#444; font-size:11px; line-height:14px;"><img src="<?php if(isset($message)){ echo $message->embed($path_ico1); } else{ echo $path_ico1;} ?>" width="9" height="12" alt="" style="display:inline-block; vertical-align:middle;">&nbsp;&nbsp;&nbsp; <?php echo $booking_content['branch_to_eng_title']; ?></td></tr>
                                ...
                                <tr>
                                	<td style="background:#eff0e0; width:50%; border-bottom:2px solid #fff; padding:18px 54px 28px" class="col-4">
                                    	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        	<tr><td><h3 style="color:#b8193d; margin:0 0 12px; font-size:12px; line-height:16px; text-transform:uppercase; font-weight:bold; font-family: 'Lato', sans-serif;">CHARGES</h3></td></tr>
                                            <?php if(round($booking_content['cdw_price']) > 0){ ?>
                                        	<tr><td>Loss Damage Waiver <strong style="color:#444;">(<?php echo $booking_content['cdw_price']; ?> SAR) x <?php echo $booking_content['no_of_days']?> DAYS</strong></td></tr>
                                            <?php } ?>

                                            <?php if(round($booking_content['cdw_plus_price']) > 0){ ?>
                                        	<tr><td>CDW Plus <strong style="color:#444;">(<?php echo $booking_content['cdw_plus_price']; ?> SAR) x <?php echo $booking_content['no_of_days']?> DAYS</strong></td></tr>
                                            <?php } ?>
                                            <?php if(round($booking_content['gps_price']) > 0){ ?>
                                            <tr><td>GPS <strong style="color:#444;">(<?php echo $booking_content['gps_price']; ?> SAR) x <?php echo $booking_content['no_of_days']?> DAYS</strong></td></tr>
                                            <?php } ?>
                                            <?php if(round($booking_content['extra_driver_price']) > 0){ ?>
                                            <tr><td>Extra driver <strong style="color:#444;">(<?php echo $booking_content['extra_driver_price']; ?> SAR) x <?php echo $booking_content['no_of_days']?> DAYS</strong></td></tr>
                                            <?php } ?>
                                            <?php if(round($booking_content['baby_seat_price']) > 0){ ?>
                                            <tr><td>Baby Car Protection Seat <strong style="color:#444;">(<?php echo $booking_content['baby_seat_price']; ?> SAR) x <?php echo $booking_content['no_of_days']?> DAYS</strong></td></tr>
                                            <?php } ?>
                                            <?php if(round($booking_content['dropoff_charges']) > 0){ ?>
                                            <tr><td>Dropoff charges <strong style="color:#444;">(<?php echo $booking_content['dropoff_charges']; ?> SAR) x <?php echo $booking_content['no_of_days']?> DAYS</strong></td></tr>
                                        <?php } ?>
                                            <!-- New -->
                                            <tr><td>RENT <strong style="color:#444;">(<?php echo $booking_content['rent_price']; ?> SAR) x <?php echo $booking_content['no_of_days']?> DAYS</strong></td></tr>
                                    ...
                                    <td style="background:#eff0e0; width:50%; border-bottom:2px solid #fff; border-left:2px solid #fff; padding:18px 54px 28px" class="col-4">
                                    	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        	<tr><td><h3 style="color:#b8193d; margin:0 0 20px; font-size:12px; line-height:16px; text-transform:uppercase; font-weight:bold; font-family: 'Lato', sans-serif;">FEATURES</h3></td></tr>
                                            <tr>
                                            	<td style="width:100%; font-size:10px; font-weight:bold;">
                                                	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    	...
                                                    	<tr>
                                                            ...
                                                            <td style="width:25%;"><p style="margin:0 0 10px;"><img src="<?php if(isset($message)){ echo $message->embed($path_ico5); } else{ echo $path_ico5;} ?>" width="18" height="18" alt="" style="display:block;"></p> <?php echo $booking_content['transmission']; ?></td>
                        	...
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            	<tr>
                                    	...
                                    	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                            	<td style="color:#fff; font-size:13px; line-height:14px; font-weight:bold; font-family: 'Lato', sans-serif;">
                                                	<p style="margin:0;">Rent rate before discount <?php echo $booking_content['original_rent']; ?> SAR</p>
                                                	<p style="margin:0;">DISCOUNT APPLIED</p>
                                                    <p style="margin:0;"><strong style="font-size:25px; line-height:25px; font-weight:900;"><?php echo $booking_content['discount_price']; ?> SAR</strong></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td style="background:#f8ab1d; border-left:2px solid #fff; width:50%; padding:24px 53px 23px; font-size:13px; margin:0; line-height:14px; font-weight:bold; color:#fff;" class="two-col">
                                        ...
                                        <p style="margin:0;"><strong style="display:block; font-size:40px; line-height:40px; font-weight:900; color:#9F063F;"><?php echo $booking_content['total_sum']; ?> SAR</strong></p>
                                        <p style="margin:0;"><span style="font-size:10px; font-weight:bold; display:inline-block;">BY</span>
