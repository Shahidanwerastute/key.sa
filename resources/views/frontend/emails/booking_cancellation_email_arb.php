                    ...
                    <td style="padding:14px 33px 14px 50px; background:#444; border-bottom:2px solid #f1af1d;" class="topbar">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td style="text-align:left;"><a href="<?php echo custom::baseurl('/'); ?>/ar" style="font-size:12px; color:#f8ac1d; font-family: 'Lato', sans-serif; text-decoration:none;"><?php echo custom::baseurl('/'); ?></a></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td style="text-align:left;">
                                    <h1 style="margin:0;font-family: 'Lato', sans-serif; font-size:22px; font-weight:400; line-height:22px; color:#f8ac1d;"> الحجز  <p style="display:block; font-size:18px; line-height:18px; color:#666; font-family:300; margin:0;"> تأكيد </p></h1></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td style="padding:27px 33px 26px 52px; background:url(<?php if(isset($message)){ echo $message->embed($path_divider); } else{ echo $path_divider;} ?>) repeat-x; border-top:1px solid #ccc;" class="intro">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td>
                                    <p style="margin:0 0 5px; color:#b8193d; font-family: 'Lato', sans-serif;font-weight:bold;"> عزيزي <?php echo ($booking_content['first_name'] != '' ? $booking_content['first_name'] : $booking_content['icg_first_name'])." ".($booking_content['last_name'] != '' ? $booking_content['last_name'] : $booking_content['icg_last_name']); ?>,</p>
                                    <p style="margin:0; width:280px; font-family: 'Lato', sans-serif;">مرفق لكم تفاصيل الحجز</p>
                                </td>
                                <td style="text-align:left;">
                                    ...
                                    <p style="margin:0; color:#444; font-family: 'Lato', sans-serif;"><?php echo $booking_content['branch_from_arb_title']; ?> <span style="color:#858585;">عن أي مساعدة</span></p>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding:14px 33px 12px 52px; background:#eff0e0;" class="bar-code">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            ?>
                            <tr>
                                <td style="font-size:12px; width:50%; font-family: 'Lato', sans-serif;"> رقم الحجز ملغي <p style="display:block; margin:0; font-size:16px; line-height:20px; font-family: 'Lato', sans-serif; font-weight:400;"><a href="javascript:void(0);" style=" color:#b8193d; text-decoration:none; cursor:default;"><?php echo $booking_content['reservation_code']; ?></a></p></td>
                                <td style="width:50%; text-align:left;"><img src="<?php if(isset($message)){ echo $message->embed($path_captcha); } else{ echo $path_captcha;} ?>" width="227" height="61" alt="bar code" style="display:inline-block;"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                ...
                                <td style="background:#eff0e0; width:50%; border-bottom:2px solid #fff; padding:18px 54px 28px" class="col-4">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <?php if(round($booking_content['cdw_price']) > 0){ ?>
                                            <tr><td> الضرر خسارة تنازل <strong style="color:#444;">(<?php echo $booking_content['cdw_price']; ?> <?php echo $currency; ?>) x <?php echo $booking_content['no_of_days']?> أيام</strong></td></tr>
                                        <?php } ?>

                                        <?php if(round($booking_content['cdw_plus_price']) > 0){ ?>
                                            <tr><td> تأمين شامل بلس <strong style="color:#444;">(<?php echo $booking_content['cdw_plus_price']; ?> <?php echo $currency; ?>) x <?php echo $booking_content['no_of_days']?> أيام</strong></td></tr>
                                        <?php } ?>
                                        <?php if(round($booking_content['gps_price']) > 0){ ?>
                                            <tr><td> غس <strong style="color:#444;">(<?php echo $booking_content['gps_price']; ?> <?php echo $currency; ?> x <?php echo $booking_content['no_of_days']?> أيام </strong></td></tr>
                                        <?php } ?>
                                        <?php if(round($booking_content['extra_driver_price']) > 0){ ?>
                                            <tr><td> سائق إضافي <strong style="color:#444;">(<?php echo $booking_content['extra_driver_price']; ?> <?php echo $currency; ?>) x <?php echo $booking_content['no_of_days']?> أيام </strong></td></tr>
                                        <?php } ?>
                                        <?php if(round($booking_content['baby_seat_price']) > 0){ ?>
                                            <tr><td> الطفل مقعد حماية السيارات <strong style="color:#444;">(<?php echo $booking_content['baby_seat_price']; ?> <?php echo $currency; ?>) x <?php echo $booking_content['no_of_days']?> أيام </strong></td></tr>
                                        <?php } ?>
                                        <?php if(round($booking_content['dropoff_charges']) > 0){ ?>
                                            <tr><td> إسقاط الرسوم <strong style="color:#444;">(<?php echo $booking_content['dropoff_charges']; ?> <?php echo $currency; ?>) x <?php echo $booking_content['no_of_days']?> أيام </strong></td></tr>
                                        <?php } ?>
                                    </table>
                                </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="background:#f8ab1d; border-left:2px solid #fff; width:50%; padding:24px 53px 23px; font-size:13px; margin:0; line-height:14px; font-weight:bold; color:#fff;" class="two-col">
                                    ...
                                    <p style="margin:0;"><strong style="display:block; font-size:40px; line-height:40px; font-weight:900; color:#9F063F;"><?php echo $booking_content['total_sum']; ?> <?php echo $currency; ?></strong></p>
                                </td>
                            </tr>
                        </table>
                    </td>
