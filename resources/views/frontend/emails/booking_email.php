				...
				<table class="userInfo" style=" width: 100%; ">
					<tr>
						...
						<td align="right" valign="top" style="padding-left: 10px; width: 50%;">
							...
							<p style="color: #858585;font-size: 13px;line-height: 1.3;margin: 0;"><strong style="color: #444444;"><?php echo $booking_content['branch_from_eng_title']; ?> </strong> for any assistance</p>
						</td>
					</tr>
				</table>
			</div>
