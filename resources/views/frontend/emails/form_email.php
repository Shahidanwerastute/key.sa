...
<table class="head-wrap" style="margin: 0 auto;max-width: 680px;width: 100%;">
	<tr>
		<td></td>
		<td class="header container" style="clear: both;display: block;margin: 0 auto;max-width: 600px">
			<div class="content" style="display: block;margin: 0 auto;max-width: 630px; padding: 0 0 0 15px;">
				<table class="userInfo" style=" width: 100%; ">
					<tr>
						<td colspan="2" align="left" valign="top" style="padding: 25px 0px 0px; ">
							<p style="color:#AB1D46; font-size: 13px; margin-bottom: 3px;line-height: 1.2;">Dear <?php echo $data['name']; ?>,</p>
		...
		<td class="header container" style="clear: both;display: block;margin: 0 auto;max-width: 600px; padding-bottom:15px;">
			<div class="content" style="display: block;margin: 0 auto;max-width: 630px;padding: 0 15px 0;" >
				...
				<?php foreach($data['info'] as $key => $info){ ?>
                    <tr>
						<td align="left" style="border:1px solid; width: 150px;padding: 0 5px;" >
							<label style="
								color: #9f063f;
								display: block;
								font-size: 12px;
							...
							"><?php echo str_replace("_"," ",$key);?>:</label>
						</td>
						<td align="left" style="border:1px solid;padding: 0 5px;" >
