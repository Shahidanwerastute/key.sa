                    	...
                    	<td style="padding:14px 33px 14px 50px; background:#444; border-bottom:2px solid #f1af1d;" class="topbar">
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            	...
                            	<tr>
                                    ...
                                    <td style="text-align:right;"><a href="<?php echo custom::baseurl('/') ?>" style="font-size:12px; color:#f8ac1d; font-family: 'Lato', sans-serif; text-decoration:none;"><?php echo custom::baseurl('/'); ?></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    	...
                    	<td style="padding:14px 33px 14px 50px;" class="thead">
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            	...
                            	<tr>
                                    ...
                                    <h1 style="margin:0;font-family: 'Lato', sans-serif; font-size:22px; font-weight:400; line-height:22px; color:#f8ac1d;">BOOKING <p style="display:block; font-size:18px; line-height:18px; color:#666; font-family:300; margin:0;">CANCELLATION</p></h1></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        	...
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            	<tr>
                                	<td>
                                        ...
                                        <p style="margin:0; width:280px; font-family: 'Lato', sans-serif;">Please find your reservation details below.</p>
                                    </td>
                                    <td style="text-align:right;">
                                ...
                                <tr>
                                	<td style="background:#eff0e0; width:50%; border-bottom:2px solid #fff; padding:18px 54px 28px" class="col-4">
                                    	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <!-- New -->
                                            <tr><td>CANCELLATION CHARGES <strong style="color:#444;"><?php echo ($booking_content['cancel_charges'] > 0 ? $booking_content['cancel_charges'].' SAR' : 'None'); ?></strong></td></tr>
                        	...
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            	<tr>
                                    <td style="background:#f8ab1d; border-left:2px solid #fff; width:50%; padding:24px 53px 23px; font-size:13px; margin:0; line-height:14px; font-weight:bold; color:#fff;" class="two-col">
                                    	...
                                    	<p style="margin:0;">REFUNDABLE AMOUNT</p>
                                        <p style="margin:0;"><strong style="display:block; font-size:40px; line-height:40px; font-weight:900; color:#9F063F;"><?php echo $booking_content['total_sum'] - $booking_content['cancel_charges']; ?> SAR</strong></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
