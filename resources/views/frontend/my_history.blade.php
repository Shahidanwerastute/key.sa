        ...
        <div class="container">
            <div class="myAccountWrapper">
                ...
                <div class="myProfDetail">
                    <?php if ($lang == 'eng')
                    { ?>
                    <h1><strong>History</strong> Bookings</h1>
                    <?php }else{ ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="myBookingRow <?php echo $highlightClass; ?>">
                                ...
                                <div class="topOptions">
                                    ...
                                    <h4>@lang('labels.your_reservation'): <span> <?php echo $booking->reservation_code; ?> </span></h4>
                                        ...
                                        <div class="col imgBox">
                                            <div class="displayTable">
                                                <div class="disTableCell">
                                                    <img src=<?php echo $car_image_path; ?> alt="<?php $booking->image1_eng_alt ?>" height="132"
                                                         width="274"/>
                                                </div>
                                            </div>
                                        </div>
