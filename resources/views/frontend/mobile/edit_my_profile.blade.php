        ...
        <div class="myAccountWrapper">
            @include('frontend.mobile.layouts.profile_inner_section')
                <div class="myProfDetail">
                    <a href="<?php echo $lang_base_url; ?>/my-profile" class="backToPage">
                        <img src="<?php echo $base_url; ?>/public/frontend/images/goBack.png" alt="<--" height="26" width="26"/>
                        @lang('labels.go_back')
                    </a>
                    <h3><strong><?php echo ($lang == 'eng' ? 'Edit' : 'تعديل'); ?> </strong> <?php echo ($lang == 'eng' ? 'My Profile' : 'ملفي الشخصي'); ?></h3>
                    <form action="<?php echo $lang_base_url; ?>/update_profile" method="post" class="edit_profile_form"
                          onsubmit="return false;">
                        <div class="row noFloatingRow">
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat">
                                <label>@lang('labels.first_name') <?php echo(isset($user_data->first_name) && $user_data->first_name != '' ? '*' : '') ?></label>
                                <input type="text" value="<?php echo $user_data->first_name; ?>" class="required" name="first_name" maxlength="20"/>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat">
                                <label>@lang('labels.last_name') <?php echo(isset($user_data->last_name) && $user_data->last_name != '' ? '*' : '') ?></label>
                                <input type="text" value="<?php echo $user_data->last_name; ?>" class="required" name="last_name" maxlength="20"/>
                            </div>

                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat" style="display: none;">
                                <label>@lang('labels.job_title') <?php echo(isset($user_data->job_title) && $user_data->job_title != '' ? '*' : '') ?></label>
                                <select name="job_title" class="<?php echo(isset($user_data->job_title) && $user_data->job_title != '' ? 'required' : '') ?>">
                                    <?php
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat" style="display: none;">
                                ...
                                <input type="text" placeholder="@lang('labels.write')" name="street_address" value="<?php echo $user_data->street_address; ?>" class="<?php echo(isset($user_data->street_address) && $user_data->street_address != '' ? 'required' : '') ?>"/>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat" style="display: none;">
                                <label>@lang('labels.district_address') <?php echo(isset($user_data->district_address) && $user_data->district_address != '' ? '*' : '') ?></label>
                                <input type="text" placeholder="@lang('labels.write')" name="district_address" value="<?php echo $user_data->district_address; ?>" class="<?php echo(isset($user_data->district_address) && $user_data->district_address != '' ? 'required' : '') ?>"/>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat nationality_container" <?php //echo $nationalityStyle; ?> style="display: none;">
                                <label>@lang('labels.nationality') <?php echo(isset($user_data->nationality) && $user_data->nationality != '' ? '*' : '') ?></label>
                                <select name="nationality" class="nationality <?php echo(isset($user_data->nationality) && $user_data->nationality != '' ? 'required' : '') ?>">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat" style="display: none;">
                                ...
                                <input type="text" value="<?php if ($user_data->dob != '0000-00-00' && $user_data->dob != '1970-01-01') echo date('d-m-Y', strtotime($user_data->dob)); ?>" class="calender <?php if (isset($user_data->dob) && $user_data->dob != '0000-00-00' && $user_data->dob != '1970-01-01') echo 'required'; ?>" name="dob"/>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat">
                                <label>@lang('labels.mobile_no') <?php echo(isset($user_data->mobile_no) && $user_data->mobile_no != '' ? '*' : '') ?></label>
                                <input type="text" value="<?php echo $user_data->mobile_no; ?>" class="phone required mobile_no number"/>
                                <input type="hidden" name="mobile_no" class="intTelNo" value="<?php echo $user_data->mobile_no; ?>">
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat sponsor" <?php echo $sponsor_style; ?>>
                                <label>@lang('labels.sponsor') <?php echo(isset($user_data->sponsor) && $user_data->sponsor != '' ? '*' : '') ?></label>
                                <input type="text" value="<?php echo $user_data->sponsor; ?>" name="sponsor" id="sponsor_field <?php echo $sponsor_class; ?>"/>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat" style="display: none;">
                                ...
                                <div class="sub-row">
                                    <select id="selectCalendar" class="selectpicker <?php echo $requiredClass; ?>" name="id_date_type">
                                    ...
                                    <div class="id_expiry_date_field">
                                        <input type="text" value="<?php if ($user_data->id_expiry_date != '0000-00-00' && $user_data->id_expiry_date != '1970-01-01') echo $id_expiry_date_formatted; ?>" class="custom_calendar <?php if ($user_data->id_expiry_date != '0000-00-00' && $user_data->id_expiry_date != '1970-01-01') echo 'required'; ?>" name="id_expiry_date"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat" style="display: none;">
                                ...
                                <div class="fileUploader">
                                    <input type="text" class="showFileName" value="<?php echo $user_data->id_image; ?>" disabled>
                                    <input type="hidden" name="old_id_image" value="<?php echo $user_data->id_image; ?>">
                                    <input type="button" class="edBtn showFileType" value="@lang('labels.upload')"/>
                                    <input type="file" class="edBtn attachFile" name="id_image" accept="application/pdf, image/*">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat" style="display: none;">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat" style="display: none;">
                                ...
                                <input type="text" value="<?php echo $user_data->license_no; ?>" name="license_no" class="validate_license_number <?php echo($user_data->license_no != '' ? 'required' : ''); ?>"/>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat" style="display: none;">
                                ...
                                <input type="text" value="<?php if (isset($user_data->license_expiry_date) && $user_data->license_expiry_date != '0000-00-00' && $user_data->license_expiry_date != '1970-01-01') echo date('d-m-Y', strtotime($user_data->license_expiry_date)); ?>" class="datepicker_future_date <?php if ($user_data->license_expiry_date != '0000-00-00' && $user_data->license_expiry_date != '1970-01-01') echo 'required'; ?>" name="license_expiry_date"/>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat" style="display: none;">
                                ...
                                <div class="fileUploader">
                                    <input type="text" class="showFileName" value="<?php echo $user_data->license_image; ?>" disabled>
                                    <input type="hidden" name="old_license_image" value="<?php echo $user_data->license_image; ?>">
                                    <input type="button" class="edBtn showFileType" value="@lang('labels.upload')"/>
                                    <input type="file" class="edBtn attachFile" name="license_image" accept="application/pdf, image/*">
                                </div>
                            </div>

                            <div class="col-md-4 col-sm-6 col-xs-12 isNoFloat">
                                <label>@lang('labels.email_address') <?php echo(isset($user_data->email) && $user_data->email != '' ? '*' : '') ?></label>
                                <input type="email" value="<?php echo $user_data->email; ?>" class="required checkEmailValid" name="email"/>
                            ...
                            <div class="col-sm-12 col-xs-12 isNoFloat buttonArea">
                                <input type="submit" value="<?php echo($lang == 'eng' ? 'Update' : 'تعديل'); ?>" class="edBtn redishButtonRound submitBtn submit_btn license_validate_btn">
                                <a href="<?php echo $lang_base_url; ?>/my-profile">
                                <input type="button" value="<?php echo($lang == 'eng' ? 'DISCARD' : 'إلغاء'); ?>" class="edBtn grayishButton"/></a>
                            </div>
                        </div>
                    </form>
                </div>
