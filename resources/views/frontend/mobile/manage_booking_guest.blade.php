        ...
        <div class="pricePgWrapper">
            <div class="leftCol">
                <div class="reservation-message">
                    <div class="heading-bar">
                        ...
                        <a href="<?php echo $lang_base_url; ?>/my-bookings" class="back2Page">
                            <img src="<?php echo $base_url; ?>/public/frontend/images/goBack.png"/>
                            @lang('labels.go_back')
                        </a>
                        <?php } ?>
                ...
                <div class="booking-details">
                    <div class="detail-holder">
                        ...
                        <ul class="userInfo">
                            <?php
                            if (isset($booking_detail->icg_email) && $booking_detail->icg_email != null) {
                                //guest info with icg_
                                $first_name = $booking_detail->icg_first_name;
                                $last_name = $booking_detail->icg_last_name;
                                $id_no = $booking_detail->icg_id_no;
                                $mobile_no = $booking_detail->icg_mobile_no;
                                $email = $booking_detail->icg_email;
                            } else {
                                ...
                                $id_no = $booking_detail->id_no;
                                $mobile_no = $booking_detail->mobile_no;
                            ...
                            <li><strong>Id:</strong> <?php echo custom::maskText($id_no, 4); ?></li>
                            <li><strong>M:</strong> <?php echo custom::maskText($mobile_no, 6); ?></li>
                            <li><strong>E:</strong> <?php echo custom::maskText($email, 3); ?></li>
                                ...
                                <ul class="<?php echo custom::hide_only_for_limousine($booking_detail->is_limousine); ?>">
                                    ...
                                    <li>
                                        ...
                                        <p><?php echo $booking_detail->cdw_price; ?> @lang('labels.currency')
                                            x <?php echo $booking_detail->no_of_days; ?>
                                            <?php echo ($booking_detail->is_delivery_mode == 'hourly' ? trans('labels.hours') : trans('labels.days')); ?>
                                        </p>
                                    </li>
                                    <?php } ?>
            ...
            <div class="rightCol">
                <div class="btn-holder">
                    <?php if($booking_detail->booking_status == "Not Picked"){
                    ...
                    <a id="bCancelBtn_<?php echo $booking_detail->id; ?>" class="grayishButton" href="javascript:void(0);" onclick="cancelBooking(<?php echo $booking_detail->id; ?>);">
                        <img src="<?php echo $base_url; ?>/public/frontend/images/cancel.png" alt="X" height="14" width="15"/>
                        <?php echo($lang == 'eng' ? 'Cancel' : 'إلغاء'); ?>
                    </a>
                    <?php } ?>
                        ...
                        <a class="bCancelBtn bEditBtn"
                           ...
                           href="<?php echo $lang_base_url . "/edit-booking/" . custom::encode_with_jwt($booking_detail->id);?>">
                            <img
                                    ...
                                    alt="E" height="14"
                                    width="15" style="margin-<?php echo ($lang == 'eng' ? 'right' : 'left'); ?>: 9px;"/><?php if ($lang == "eng") echo "Edit"; else
                                echo "تعديل"; ?>
                        </a>
                        <?php } ?>
                    ...
                    <!--<a class="shareBtn" href="javascript:void(0);" target="_blank">
                ...
                $check_logged_in = Session::get('logged_in_from_frontend');
                ...
                <div class="section-hl">
                    <form method="get" class="getYourCarForm" action="<?php echo $lang_base_url; ?>/get-car/<?php echo base64_encode($booking_detail->id); ?>" >
                        ...
                        <div class="getCar" >
                            ...
                            <?php }else{ ?>
                                <a href="javascript:void(0);" class="btn_getCar getCarGuest" id="openLoginDDB">
                                    @lang('labels.btn_get_your_car')
                                </a>
                            <?php } ?>
                ...
                <div class="section-hl">
                    ...
                    <?php }else{ ?>
                        <a href="javascript:void(0);"data-bs-toggle="modal" data-bs-target="#model-login" class="btn_endTrip">
                            @lang("labels.end_trip")
                        </a>
                    <?php } ?>
                </div>
                <?php } ?>
