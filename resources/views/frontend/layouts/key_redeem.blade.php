...
<div class="promoCodeArea redeemApplySection forWebsite keyArea" data-bs-toggle="modal" data-bs-target="#redeem-modal">
...
<?php } else { ?>
<div class="promoCodeArea redeemApplySection forWebsite keyArea" id="applyRedeemBtn">
    <div class="qitafContent" style="width: 100%;">
        <div class="logo-box-sec">
            <img src="https://kra.ced.sa/public/frontend/images/key-redeem.png" class="qitafLogo">
        </div>
