...
<div class="accountTopHead">
    <div class="row">
        <div class="col-sm-6 text-left profile-user-name-section">
            <h3>
                <?php echo($lang == 'eng' ? 'Welcome' : 'مرحبا'); ?>
                <strong><?php echo Session::get('user_name'); ?></strong>
            </h3>
        </div>
        <div class="col-sm-6 text-right profile-btns-section">
            ...
            <?php if (isset($user_data) && $site_settings->show_account_deletion_button == 1) { ?>
                <a href="javascript:void(0);" class="grayEdBtn" onclick="delete_account('<?php echo $user_data->id_no; ?>');" style="background: red;min-width: 110px;"><?php echo($lang == 'eng' ? 'Delete Account' : 'حذف الحساب'); ?></a>
            <?php } ?>
    ...
    <div class="accMeny_Details">
        ...
        <div class="leftMenu">
            <ul>
                <li class="<?php echo $profileActive; ?>"><a
                            href="<?php echo $lang_base_url; ?>/my-profile"><?php echo($lang == 'eng' ? 'Profile' : 'الملف الشخصي'); ?></a>
                </li>
                <li class="<?php echo $myBookingsActive; ?>"><a
                            href="<?php echo $lang_base_url; ?>/my-bookings"><?php echo($lang == 'eng' ? 'Bookings' : 'الحجوزات'); ?></a>
                </li>
<!--                <li class="<?php echo $myHistoryActive; ?>"><a
                            href="<?php echo $lang_base_url; ?>/my-history"><?php echo($lang == 'eng' ? 'History' : 'الحجوزات السابقة'); ?></a>
                </li>-->
            </ul>
        </div>
