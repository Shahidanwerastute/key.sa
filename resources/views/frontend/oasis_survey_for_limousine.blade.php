            ...
            <div class="row align-items-center justify-content-md-between">
                ...
                <div class="col-md-4 logo-area">
                    <div class="langSwticherArea">
                        ...
                        { ?>
                        <a href="javascript:void(0);" onclick="changeLanguageForOasis('<?php echo $lang; ?>', 1);"> <img
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="note">
                            ...
                            <?php
                            $questions = [
                                'cleanliness_of_the_vehicle_internally_and_externally' => ($lang == 'eng' ? "Cleanliness of the vehicle internally & externally" : "النظافة الداخلية والخارجية للسيارة"),
                                'commitment_to_timing' => ($lang == 'eng' ? "Commitment to timing" : "الالتزام بالوقت"),
                                'commitment_to_traffic_rules_and_safety' => ($lang == 'eng' ? "Commitment to traffic rules & safety" : "الالتزام بقواعد المرور والسلامة"),
                            ];

                            $questions_2 = [
                                'driver_commitment_to_uniform' => ($lang == 'eng' ? "Driver's commitment to uniform" : "التزام السائق بالزي الرسمي"),
                                'driver_commitment_to_personal_hygiene' => ($lang == 'eng' ? "Driver's commitment to personal hygiene" : "التزام السائق بالنظافة الشخصية"),
                            ];
                            ?>

                        <form id="saveOasisSurveyFeedback" method="POST"
                              action="<?php echo $lang_base_url . '/saveOasisSurveyFeedbackForLimousine'; ?>"
                            ...
                            <input type="hidden" name="questions_count" id="questions_count"
                                   value="<?php echo count($questions) + count($questions_2); ?>">
                            ...
                            <div class="rate-main-box">
                                <div class="rate-radio-box">
                                    <ul>
                                        ...
                                        <?php
                                        foreach ($questions_2 as $key => $value) { ?>
                                        <li>
                                            <div class="title"><?php echo $value; ?> *</div>
                                            <div class="radio-btn-box">
                                            <span>
                                                <input type="radio" id="question-<?php echo $i; ?>-option-1" name="question-<?php echo $i; ?>" value="<?php echo $key; ?>-Yes">
                                                <label for="question-<?php echo $i; ?>-option-1"><?php echo($lang == 'eng' ? 'Yes' : 'نعم'); ?></label>
                                            </span>
                                                <span>
                                                <input type="radio" id="question-<?php echo $i; ?>-option-2" name="question-<?php echo $i; ?>" value="<?php echo $key; ?>-No">
                                                <label for="question-<?php echo $i; ?>-option-2"><?php echo($lang == 'eng' ? 'No' : 'لا'); ?></label>
                                            </span>
                                            </div>
                                        </li>
                                        <?php $i++; } ?>
