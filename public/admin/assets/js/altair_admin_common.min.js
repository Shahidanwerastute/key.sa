...
altair_page_onload = {
    ...
    dynamic_fields: function() {
        $(".btnSectionClone").on("click", function(e) {
            ...
            n.attr("data-section-added", t).removeAttr("id").find(".md-input").each(function(e) {
                var a = $(this),
                    i = a.attr("name");
                a.val("").attr("name", i), altair_md.update_input(a)
    ...
    content_preloader_show: function(e, a) {
        if (!$body.find(".content-preloader").length) {
            var i = isHighDensity() ? "@2x" : "",
                t = "undefined" != typeof e && "regular" == e ? '<img src="assets/img/spinners/spinner' + i + '.gif" alt="" width="32" height="32">' : '<div class="md-preloader"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="32" width="32" viewbox="0 0 75 75"><circle cx="37.5" cy="37.5" r="33.5" stroke-width="8"/></svg></div>',
                n = "undefined" != typeof a ? a : $body;
    ...
    color_picker: function(e, a) {
        if (e) {
            for (var i = randID_generator(), t = a ? a : ["#e53935", "#d81b60", "#8e24aa", "#5e35b1", "#3949ab", "#1e88e5", "#039be5", "#0097a7", "#00897b", "#43a047", "#689f38", "#ef6c00", "#f4511e", "#6d4c41", "#757575", "#546e7a"], n = t.length, s = $('<div class="cp_altair" id="' + i + '"/>'), r = 0; r < n; r++) s.append("<span data-color=" + t[r] + ' style="background:' + t[r] + '"></span>');
    ...
    ie_fix: function() {
        Function("/*@cc_on return document.documentMode===10@*/")() && $html.addClass("lt-ie10"), ($html.hasClass("lt-ie10") || $html.hasClass("lte-ie9")) && setTimeout(function() {
            $("svg,canvas,video").each(function() {
                var e = $(this),
                    a = $(this).attr("height");
                a && e.css("height", a), e.hasClass("peity") && e.prev("span").peity();
            })
        }, 3e3)
    }
}, altair_uikit = {
